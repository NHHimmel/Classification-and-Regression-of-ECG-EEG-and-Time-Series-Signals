...
DATASET_NAME = "abnormal_heartbeat"
...
train_dl, val_dl, test_dl = load_dataset(
    dataset_name="abnormal_heartbeat", base_path=BASE_PATH,
...
for model_name in MODELS:
    ...
    criterion = nn.CrossEntropyLoss(torch.tensor(CONFIG.get('class_weights', None)))
